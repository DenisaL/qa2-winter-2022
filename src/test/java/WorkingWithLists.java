...
public class WorkingWithLists {
    ...
    public void createAndWorkWithLists() {
        ...
        Student liga = new Student("Liga", "Ivanova", "liga@tester.lv", "+37125252525");
        Student dimko =  new Student("Dimko", "Skatinishe", "dimko@tester.lv", "+37187878787");
        ...
        //------------------------------------FOR-------------------------------------------------------------------
        for (int i = 0; i < students.size(); i++) {  //i = 1 + 1 ->> i++
